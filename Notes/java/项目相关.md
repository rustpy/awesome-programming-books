...
3、去程和返程时间（时间可自定义区间）机酒往返时间段

4、划线价（原价），已省XXX元（FltHotelRTRecommendList - DiscountInfoList（DiscountInfoType） - Amount）
...
结婚预算：婚纱照8000、婚纱&西服5000、彩礼40000、装修90000、家具家私50000、三金30000、婚礼筹备30000
